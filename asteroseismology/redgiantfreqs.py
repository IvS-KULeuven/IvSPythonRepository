...
def mainx():
    ...
    # First model the frequencies of the pure pressure modes.
    frequenciesUniversalPattern = universalPattern(largeSep, smallSep, centralRadial)
    # Next, we calculate the frequencies of the mixed dipole modes:
    mixedModesPattern = asymptoticRelation(centralRadial,largeSep, DeltaPg, qCoupling)
    rotationalSplittingModulation = symmetricRotationalModulation(dfMax, largeSep, frequenciesUniversalPattern, mixedModesPattern, lambdaParam, beParam)
